...
const CreateInstitution = () => {
    ...
    const handleCreateInstitution = () => {
        ...
        localStorage.setItem("institutes", JSON.stringify([...institutions, newInstitution]));
        setInstitutionName('');
                    ...
                    <div className="max-w-6xl mx-auto mt-5">
                        ...
                        {institutions?.length > 0 ? (
                                ...
                                {institutions.map(inst => (
                                    ...
                                    >
                                        <div className="p-6 flex-1">
                                            <div className="flex justify-between items-start mb-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <h2 className="text-lg font-semibold text-gray-900 mr-4">{inst.instituteName}</h2>
                                                </div>
                                        ...
                                        <div className="bg-gray-50 px-6 py-3 flex justify-between border-t border-gray-200">
                                            ...
                                            <button
                                                onClick={() => handleInstitutionRename(inst.instituteId)}
                            ...
                            <div className="flex flex-col items-center justify-center text-center mt-10">
                                ...
                                <button
                                    onClick={() => setIsCreateModalOpen(true)}
                                    className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-lg shadow-md hover:scale-105 hover:shadow-[0_0_20px_rgba(99,102,241,0.6)] transition-all duration-300"
                                >
                                    <FaPlus className="text-lg" /> Create Institution
                                </button>
                            </div>
